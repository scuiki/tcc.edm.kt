...
- [x] 05-05-PLAN.md — TOOL-01: proposta da aplicação + pipeline `.bridge-seq` 6 etapas neutras (D-94; Pitfall 1 overflow)
- [x] 05-06-PLAN.md — Fechamento: STYLE.md §Inventário 27→31 + §Gaps removido + §Classes reutilizáveis estendido; PROJECT.md REQ-IDs Active→Validated + D-92/D-93b; Validation Checklist D-104 (17 itens)
